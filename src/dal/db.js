...
db.exec('CREATE INDEX IF NOT EXISTS idx_patients_id ON patients(id);');
db.exec('CREATE INDEX IF NOT EXISTS idx_patients_code ON patients(ma_bn);');
db.exec('CREATE INDEX IF NOT EXISTS idx_visits_patient_date ON visits(patient_id, ngay_kham);');
db.exec('CREATE INDEX IF NOT EXISTS idx_visit_images_visit ON visit_images(visit_id);');

...
function createDoctor(payload) {
  ...
  const doctorCategory =
    payload.doctorCategory === 'assigned' || payload.isAssignedDoctor === true || payload.isAssignedDoctor === 'true'
      ? 'assigned'
      : 'specialist';
  const doctor = {
    id,
    ...
    phone,
    doctorCategory,
    isAssignedDoctor: doctorCategory === 'assigned',
...
function updateDoctor(id, payload) {
  ...
  const updated = {
    ...
    doctorCategory:
      payload.doctorCategory === 'assigned' ||
      (payload.doctorCategory === undefined && (payload.isAssignedDoctor === true || payload.isAssignedDoctor === 'true'))
        ? 'assigned'
        : payload.doctorCategory === 'specialist'
          ? 'specialist'
          : doctor.doctorCategory || (doctor.isAssignedDoctor ? 'assigned' : 'specialist'),
    isAssignedDoctor:
      (payload.doctorCategory || doctor.doctorCategory || '') === 'assigned' ||
      (payload.doctorCategory === undefined &&
        payload.isAssignedDoctor !== undefined &&
        (payload.isAssignedDoctor === true || payload.isAssignedDoctor === 'true')) ||
      (payload.doctorCategory === undefined && payload.isAssignedDoctor === undefined && !!doctor.isAssignedDoctor),
    id: doctor.id
  };

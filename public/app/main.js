...
function parsePath(pathname) {
  ...
  if (pathname === '/kham-trong-ngay') return { view: 'daily' };
  if (pathname === '/benh-nhan') return { view: 'patients' };
  if (pathname === '/bac-si') return { view: 'doctors' };
  if (pathname === '/mau-ket-qua') return { view: 'templates' };

...
export const api = {
  ...
  async createPatient(payload) {
    const res = await fetch('/api/patients', { method: 'POST', headers: JSON_HEADERS, body: JSON.stringify(payload) });
    return handleResponse(res);
  },
  ...
  async createDoctor(payload) {
    const res = await fetch('/api/doctors', { method: 'POST', headers: JSON_HEADERS, body: JSON.stringify(payload) });
    return handleResponse(res);
  },
  ...
  async getVisitPrintData(id) {
    const res = await fetch(`/api/visits/${encodeURIComponent(id)}/print-data`);
    return handleResponse(res);
  },
  ...
  async listVisitImages(visitId) {
    ...
    const res = await fetch(`/api/visit-images?${qs}`);
    return handleResponse(res);
  },
  async uploadVisitImage(payload) {
    const res = await fetch('/api/visit-images', { method: 'POST', headers: JSON_HEADERS, body: JSON.stringify(payload) });
    return handleResponse(res);
  },
  async deleteVisitImage(id) {
    const res = await fetch(`/api/visit-images/${encodeURIComponent(id)}`, { method: 'DELETE' });
    return handleResponse(res);
  },

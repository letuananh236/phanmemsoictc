...
function renderPrintSheet({ patient, exam, settings, logoShape, formattedDate, doctorName, reason, examImages, printImageLayout }) {
  ...
  const indication = patient?.indication || '';
    ...
    <div class="print-sheet ${printImageLayout}">
      <div class="print-body">
        ...
        <div class="info-lines">
          ...
          <div class="info-line">
            <span class="label">Chẩn đoán lâm sàng:</span> ${visitReason}
          </div>
          <div class="info-line">
            <span class="label">Chỉ định:</span> ${indication}
          </div>
          <div class="info-line">
            <span class="label">Bác sỹ chỉ định:</span> ${assignedDoctor}
          </div>
        </div>
